...
published_after <- "2017-06-21T00:00:00Z" # from date he became crown prince
...
saveRDS(all_vids, "data/output/mbsvids2.rds")
...
saveRDS(all_rel_vids, "data/output/mbsrelatedvids2.rds")
